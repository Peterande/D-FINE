        ...
        if self.num_encoder_layers > 0:
            for i, enc_ind in enumerate(self.use_encoder_idx):
                ...
                if self.training or self.eval_spatial_size is None:
                    ...
                    # In eval, we may have a cached pos_embed built for eval_spatial_size.
                    # If the current feature map size differs (e.g. evaluating at a different image size),
                    # the cached embedding will have a different token count and will crash in attention.
