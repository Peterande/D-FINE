...
#         image_path = os.path.join('/data/pengys/Objects365/data/train/', image_info['file_name'])
...
#     json_file_path = '/data/pengys/Objects365/data/train/new_zhiyuan_objv2_train.json'
...
def resize_images_and_update_annotations(json_file, max_size=640):
    ...
    def process_image(image_info):
        image_path = os.path.join('/data/pengys/Objects365/data/val/', image_info['file_name'])
        results = resize_image_and_update_annotations(image_path, image_annotations[image_info['id']], max_size)
        if results is None:
            updated_annotations, new_w, new_h, resized = None, None, None, None
        else:
...
if __name__ == "__main__":
    # Replace with the path to your JSON file
    json_file_path = '/data/pengys/Objects365/data/val/new_zhiyuan_objv2_val.json'
    resize_images_and_update_annotations(json_file_path)